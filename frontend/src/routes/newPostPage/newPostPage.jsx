...
import { FaPlusCircle } from "react-icons/fa"; // Import icon
  ...
  return (
    <div className="newPostPage">
      <div className="formContainer">
        <h1>
          <FaPlusCircle /> Add New Post {/* Thêm icon vào tiêu đề */}
        </h1>
        <div className="wrapper">
          <form onSubmit={handleSubmit}>
            ...
            <button className="sendButton">
              <FaPlusCircle /> Add {/* Thêm icon vào nút */}
            </button>
          </form>
        </div>
      </div>
